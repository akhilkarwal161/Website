...
└── tests
    ├── debug_live_site.py
    ├── recreate_zone.py
    ├── recreate_zone_parallel.py
    ├── test_live_darkmode.py
    ├── test_live_site.py
    └── test_playwright.py
...
- **2026-05-31**: 
    - **Integrated Green API for WhatsApp Notifications**: Refactored `contact_view` to send real-time alerts for new form submissions.
...
FILE: README.md
================================================
Error reading file with 'cp1252': 'charmap' codec can't decode byte 0x8f in position 1856: character maps to <undefined>
...
================================================
# Django Core and Server
Django==5.2.4
gunicorn==23.0.0

# Django Apps & Frameworks
...
# Dependencies (usually installed automatically by other packages)
asgiref==3.9.1
...
venv/
myprojectenv/  # Your virtual environment folder
...
# Ignore Django-specific development files
.env       # Environment variables file (should not be in the image)

# Ignore collected static files if you collect them locally before building.
# However, our Dockerfile runs `collectstatic` inside the container,
# so you might want to keep this commented out or remove it if you want
# the `staticfiles` directory to be created within the image.
staticfiles/

# Ignore media files if they are user-uploaded and will be stored externally
# (e.g., S3, Google Cloud Storage) or mounted as a volume.
# If you plan to store media directly in the container for a very small app,
# you might remove this line, but it's generally not recommended for production.
# mediafiles/
...
# Any other local development files or logs
*.log
tmp/
django_cache/
# Ignore Docker-related files that are not needed in the image


================================================
FILE: mainweb/__init__.py
================================================
[Empty file]


================================================
FILE: mainweb/asgi.py
================================================
"""
...
MIDDLEWARE = [
    'persinfo.middleware.WwwRedirectMiddleware',  # SEO: 301 redirect www â†’ non-www
...
================================================
FILE: persinfo/__init__.py
================================================
[Empty file]


================================================
FILE: persinfo/admin.py
================================================
# persinfo/admin.py
from django.contrib import admin
...
================================================
FILE: persinfo/apps.py
================================================
from django.apps import AppConfig


class PersinfoConfig(AppConfig):
    default_auto_field = 'django.db.models.BigAutoField'
    name = 'persinfo'
...
================================================
FILE: persinfo/middleware.py
================================================
# persinfo/middleware.py
# Redirects www.akhilkarwal.com â†’ akhilkarwal.com (canonical non-www)
...
================================================
FILE: persinfo/tests.py
================================================
Error reading file with 'cp1252': 'charmap' codec can't decode byte 0x81 in position 1246: character maps to <undefined>


================================================
FILE: persinfo/urls.py
================================================
# persinfo/urls.py
...
================================================
FILE: persinfo/migrations/0001_initial.py
================================================
...
================================================
FILE: persinfo/migrations/__init__.py
================================================
[Empty file]


================================================
FILE: persinfo/static/site.webmanifest
================================================
{
  "name": "Akhil Karwal's Portfolio",
  "short_name": "Akhil K.",
  "icons": [
    {
...
================================================
FILE: persinfo/static/css/style.css
================================================
/* persinfo/static/css/style.css */
:root {
    --bg-primary: #f4f4f4;
    --bg-secondary: #ffffff;
    --text-primary: #333333;
...
/* Project grid and card optimizations */
.project-grid {
    display: grid;
...
.social-link.github { background: linear-gradient(135deg, #24292e, #2b3137); }
.social-link.linkedin { background: linear-gradient(135deg, #0077b5, #00a0dc); }
.social-link.email { background: linear-gradient(135deg, #ea4335, #c5221f); }
.social-link.instagram { background: linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%); }
.social-link.facebook { background: linear-gradient(135deg, #1877f2, #3b5998); }
...
.slider {
    ...
    background: linear-gradient(135deg, #7ec0ee, #4a90e2);
    transition: 0.5s;
    border-radius: 30px;
    overflow: hidden;
}
...
input:checked + .slider { background: linear-gradient(135deg, #0f2027, #203a43); }
input:checked + .slider::before { transform: translateX(30px); background-color: #d1d5db; }
...
================================================
FILE: persinfo/static/js/main.js
================================================
// persinfo/static/js/main.js
...
================================================
FILE: persinfo/templates/404.html
================================================
{% extends 'base.html' %} {% load static %} {% block title %}Page Not Found
(404) - Akhil Karwal{% endblock %} {% block content %}
...
================================================
FILE: persinfo/templates/500.html
================================================
{% extends 'base.html' %} {% load static %} {% block title %}Server Error (500)
- Akhil Karwal{% endblock %} {% block content %}
<section class="section" style="text-align: center; padding: 4rem 1rem">
  <div class="container">
    <h1 style="font-size: 5rem; margin-bottom: 0">500</h1>
    <h2>Internal Server Error</h2>
    <p style="font-size: 1.2rem; margin-top: 1rem">
      Sorry, something went wrong on our end. We are working to fix it.
    </p>
    <p>Please try again later. You can return to the homepage.</p>
    <a
      href="{% url 'persinfo:home' %}"
      class="btn"
      style="
...
================================================
FILE: persinfo/templates/persinfo/404.html
================================================
{% extends 'base.html' %} {% load static %} {% block title %}Page Not Found
(404) - Akhil Karwal{% endblock %} {% block content %}
<section class="section" style="text-align: center; padding: 4rem 1rem">
...
================================================
FILE: persinfo/templates/persinfo/429.html
================================================
{% extends 'persinfo/base.html' %} {% load static %} {% block title %}Too Many Requests (429) - Akhil Karwal{% endblock %} {% block content %}
<section class="section" style="display: flex; justify-content: center; align-items: center; min-height: 60vh; padding: 2rem 1rem;">
  ...
  ">
    ...
    <div class="shield-container" style="margin-bottom: 1.5rem;">
      <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="animation: pulse 2s infinite ease-in-out;">
        <path d="M12 22C12 22 20 18 20 12V5L12 2L4 5V12C4 12 4 22 12 22Z" stroke="#ffc107" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="rgba(255, 193, 7, 0.1)"/>
        <path d="M12 8V12" stroke="#ffc107" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M12 16H12.01" stroke="#ffc107" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </div>

    <h1 style="font-size: 2.5rem; margin-top: 0; margin-bottom: 0.5rem; color: #ffc107;">429</h1>
    <h2 style="margin-top: 0; margin-bottom: 1rem; font-weight: 600;">Too Many Requests</h2>
    
    <p style="font-size: 1.1rem; line-height: 1.6; color: var(--text-secondary); margin-bottom: 2rem;">
      Whoa there, partner! You are requesting pages too quickly. Our system has rate-limited your IP temporarily to prevent spam and resource drain.
    </p>

    <!-- Client-side Countdown Widget -->
    <div style="
      ...
      margin-bottom: 2rem;
    ">
      <span style="font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--text-secondary); display: block; margin-bottom: 0.25rem;">Please Wait</span>
      <span id="countdown-timer" style="font-size: 2rem; font-weight: bold; color: var(--text-primary);">60</span>
      <span style="font-size: 0.9rem; color: var(--text-secondary); display: block; margin-top: 0.25rem;">seconds before retrying</span>
    </div>

    <a href="{% url 'persinfo:home' %}" id="retry-button" class="btn" style="
      display: inline-block;
      width: 100%;
      padding: 12px 24px;
...
<!-- Pulse Animation Style & Countdown Logic -->
<style>
  @keyframes pulse {
    0% { transform: scale(1); }
    50% { transform: scale(1.05); filter: drop-shadow(0 0 8px rgba(255, 193, 7, 0.4)); }
...
================================================
FILE: persinfo/templates/persinfo/500.html
================================================
{% extends 'base.html' %} {% load static %} {% block title %}Server Error (500)
- Akhil Karwal{% endblock %} {% block content %}
<section class="section" style="text-align: center; padding: 4rem 1rem">
...
================================================
FILE: persinfo/templates/persinfo/base.html
================================================
{%load compress%}
{% load static %}
<!DOCTYPE html>
...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-3KEMX58YYS"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-3KEMX58YYS');
    </script>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{% block title %}Akhil Karwal's Portfolio{% endblock %}</title>

    <!-- SEO & Social Sharing Meta Tags -->
    <meta name="description" content="{% block meta_description %}Welcome to the personal portfolio of Akhil Karwal, a passionate developer. Discover my projects and skills.{% endblock %}">
    <link rel="canonical" href="{{ request.build_absolute_uri }}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="{% block og_type %}website{% endblock %}">
    <meta property="og:url" content="{{ request.build_absolute_uri }}">
    <meta property="og:title" content="{% block og_title %}Akhil Karwal - Personal Portfolio{% endblock %}">
    <meta property="og:description" content="{% block og_description %}Welcome to the personal portfolio of Akhil Karwal, showcasing projects and skills.{% endblock %}">
    <meta property="og:image" content="{% block og_image %}{{ request.scheme }}://{{ request.get_host }}{% static 'images/default_og_image.png' %}{% endblock %}">
    ...
    {% endblock %}
    <script>
        // Only apply a saved theme if the user explicitly chose one via the toggle.
        // Default is always light â€” do NOT auto-apply OS dark mode preference.
        try {
    ...
    <!-- Font Awesome â€” non-blocking (fixes render-blocking resources warning) -->
...
<body>
    <header>
        <nav>
            <div class="nav-brand-container" style="display: flex; flex-direction: column; align-items: flex-start; gap: 8px;">
                <h1><a href="{% url 'persinfo:home' %}" style="margin: 0; line-height: 1.1;">Akhil Karwal</a></h1>
            ...
            <ul>
                <li><a href="{% url 'persinfo:home' %}">Home</a></li>
                <li><a href="{% url 'persinfo:projects' %}">Projects</a></li>
                <li><a href="{% url 'persinfo:contact' %}">Contact</a></li>
            </ul>
        </nav>
    </header>
    ...
    <footer>
        <div class="footer-inner">
            <div class="footer-social-links">
                <a href="https://github.com/akhilkarwal161" target="_blank" rel="noopener noreferrer" class="footer-social-link">
                    <i class="fab fa-github"></i> GitHub
                </a>
                <a href="https://www.linkedin.com/in/akhil-karwal-ba5114235/" target="_blank" rel="noopener noreferrer" class="footer-social-link">
                    <i class="fab fa-linkedin"></i> LinkedIn
                </a>
                <a href="https://www.instagram.com/akhilkarwal161/" target="_blank" rel="noopener noreferrer" class="footer-social-link">
                    <i class="fab fa-instagram"></i> Instagram
                </a>
                <a href="https://www.facebook.com/akhilkarwal161/" target="_blank" rel="noopener noreferrer" class="footer-social-link">
                    <i class="fab fa-facebook-f"></i> Facebook
                </a>
            </div>
            <p>&copy; {% now "Y" %} Akhil Karwal. All rights reserved.</p>
        </div>
    </footer>
    ...
    <!-- Dual-Layer Preloading: Speculation Rules API & Quicklink -->
      ...
      "prerender": [
        {
          ...
          "where": {
            "and": [
              { "href_matches": "/*" },
              { "not": { "href_matches": ["*.zip", "*.pdf", "*.mp4", "*.tar.gz", "*#*"] } }
            ]
          },
          "eagerness": "moderate"
        }
    ...
    <script>
        window.addEventListener('load', () => {
            ...
            if (!isSlow && !supportsSpeculationRules && window.quicklink) {
                quicklink.listen({
                    ignores: [
                        uri => uri.includes('#'),
                        uri => uri.match(/\.(zip|pdf|mp4|tar\.gz)$/i)
                    ]
                });
            }
        });
    ...
    <script>
        ...
        // Synchronize toggle switch state on load
        const currentTheme = document.documentElement.getAttribute('data-theme') || 'light';
        toggleCheckbox.checked = (currentTheme === 'dark');
        
        toggleCheckbox.addEventListener('change', () => {
            const target = toggleCheckbox.checked ? 'dark' : 'light';
...
================================================
FILE: persinfo/templates/persinfo/contact.html
================================================
{% extends 'persinfo/base.html' %}

{% block meta_description %}Get in touch with Akhil Karwal â€” Python and Django web developer. Connect via GitHub, LinkedIn, Instagram, Facebook or send a direct message. Open to collaboration, job opportunities, and freelance projects.{% endblock %}
...
{% block content %}
    ...
    <div class="container profile-page">
        ...
        <p>
            You can find me on the following platforms. I'm always open to connecting
            with fellow developers and collaborators!
        </p>

        <div class="social-links">
            <a
            href="https://github.com/akhilkarwal161"
            target="_blank"
            ...
            <a
            href="https://www.linkedin.com/in/akhil-karwal-ba5114235/"
            target="_blank"
            rel="noopener noreferrer"
            ...
            <a
            href="https://www.instagram.com/akhilkarwal161/"
            target="_blank"
            rel="noopener noreferrer"
            ...
            <a
            href="https://www.facebook.com/akhilkarwal161/"
            target="_blank"
            rel="noopener noreferrer"
            ...
            <a href="mailto:akhilkarwal161@gmail.com" class="social-link email">
    ...
    <section class="section">
        ...
        <form method="post">
            ...
            <div style="display: none; visibility: hidden;">
                <label for="honeypot">If you are human, leave blank:</label>
...
================================================
FILE: persinfo/templates/persinfo/home.html
================================================
{% extends 'persinfo/base.html' %}

{% block title %}Akhil Karwal â€” Python & Django Developer Portfolio{% endblock %}

{% block meta_description %}Akhil Karwal is a results-oriented Python and Django web developer based in India, specialising in scalable web apps, automation testing with Playwright & Selenium, Docker containerisation, and AI-powered tools. Open to opportunities â€” view projects and connect.{% endblock %}

{% block og_title %}Akhil Karwal â€” Python & Django Developer{% endblock %}
{% block og_description %}Explore Akhil Karwal's portfolio of Python, Django, and AI projects. Skilled in web development, automation, and containerisation. Available for collaboration and full-time roles.{% endblock %}
...
<script type="application/ld+json">
{
  ...
  "description": "Results-oriented Python and Django web developer specialising in scalable web applications, automation testing, and AI-powered tools.",
  "knowsAbout": ["Python", "Django", "Docker", "Playwright", "Selenium", "Java", "REST APIs"],
  "sameAs": [
    "https://github.com/akhilkarwal161",
    "https://www.linkedin.com/in/akhil-karwal-ba5114235/",
    "https://www.instagram.com/akhilkarwal161/",
    "https://www.facebook.com/akhilkarwal161/"
  ]
}
</script>
{% endblock %}
...
{% block content %}
    <section class="hero">
        <h2>Hi, I'm Akhil Karwal</h2>
        <p>A results-oriented and passionate web developer with a strong foundation in building high-quality, scalable applications. Proficient in Python, Django, and SQL, with hands-on experience in containerization using Docker. Eager to leverage software engineering best practices to contribute to innovative projects, drive product quality, and create robust, user-friendly web solutions. A strong collaborator and effective problem-solver who thrives in a team-oriented environment.</p>
        <a href="{% url 'persinfo:projects' %}" class="btn">View My Work</a>
    </section>
        ...
        <div class="project-grid">
            {% for project in projects %}
                <div class="project-card">
                    ...
                    {% if project.outcome %}
                        <span class="project-outcome">âœ“ {{ project.outcome }}</span>
                    {% endif %}
                    <br>
                    <a href="{% url 'persinfo:project_detail' project.id %}" class="read-more">Learn More</a>
                </div>
            {% empty %}
...
================================================
FILE: persinfo/templates/persinfo/project.html
================================================
{% extends 'persinfo/base.html' %}

{% block meta_description %}{{ project.description|striptags|truncatewords:25 }}{% endblock %}
...
<section class="section">
  <div class="project-details">
    ...
    {% if project.github_link %}
      <p><a href="{{ project.github_link }}" target="_blank" class="btn-link">View on GitHub</a></p>
    {% endif %}
    {% if project.live_link %}
      <p><a href="{{ project.live_link }}" target="_blank" class="btn-link">Live Demo</a></p>
    {% endif %}
  </div>

  <div class="project-navigation">
    {% if prev_project %}
      <a href="{% url 'persinfo:project_detail' prev_project.id %}" class="btn">&larr; Previous Project</a>
    {% else %}
      <span></span> {# Empty span for alignment purposes #}
    {% endif %}
    <a href="{% url 'persinfo:projects' %}" class="btn">All Projects</a>
    {% if next_project %}
      <a href="{% url 'persinfo:project_detail' next_project.id %}" class="btn">Next Project &rarr;</a>
    {% endif %}
  </div>
</section>
{% endblock %}
...
================================================
FILE: persinfo/templates/persinfo/project_detail.html
================================================
{% extends "persinfo/base.html" %} {% load static %} {# Assuming you pass a
'project' object to this template from your view #} {% block title %}{{
project.title }} - Akhil Karwal{% endblock %} {% block description %}{{
project.short_description }}{% endblock %} {% block og_type %}article{% endblock
%} {% block og_title %}{{ project.title }} - Akhil Karwal's Portfolio{% endblock
%} {% block og_description %}{{ project.short_description }}{% endblock %} {%
block og_image %}{% if project.image %}{{ project.image.url }}{% else %}{%
static 'images/default_og_image.png' %}{% endif %}{% endblock %} {% block
content %}
<h1>{{ project.title }}</h1>
{% if project.image %}
<img
...
================================================
FILE: persinfo/templates/persinfo/projects.html
================================================
{% extends 'persinfo/base.html' %}

{% block meta_description %}Browse all projects by Akhil Karwal â€” a Python and Django developer. Explore web apps, AI tools, and automation projects built with Django, Flask, Docker, Playwright, and Selenium. View live demos and source code on GitHub.{% endblock %}
    ...
    <section class="section">
        ...
        <div class="project-grid">
            {% for project in all_projects %}
                <div class="project-card">
                    <div>
                        <h4><a href="{% url 'persinfo:project_detail' project.id %}">{{ project.title }}</a></h4>
                        <p>{{ project.description|truncatechars:180 }}</p>
                    ...
                    <div class="project-links">
                        ...
                        {% endif %}
                        <a href="{% url 'persinfo:project_detail' project.id %}" class="read-more">
                            Details &rarr;
                        </a>
                    </div>
                </div>
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="{% block description %}Welcome to the personal portfolio of Akhil Karwal.{% endblock %}">

    <!-- Keywords Tag -->
    <meta name="keywords" content="{% block keywords %}Akhil Karwal, portfolio, developer, python, django, projects, software engineer{% endblock %}">
    ...
    <meta property="profile:first_name" content="Akhil">
    <meta property="profile:last_name" content="Karwal">
    <meta property="og:url" content="{% block og_url %}{{ request.build_absolute_uri }}{% endblock %}">
    <meta property="og:site_name" content="Akhil Karwal's Portfolio">
    <meta property="og:title" content="{% block og_title %}Akhil Karwal - Personal Portfolio{% endblock %}">
    <meta property="og:description" content="{% block og_description %}Welcome to the personal portfolio of Akhil Karwal, showcasing projects and skills.{% endblock %}">
    {# Make sure to create a default image and place it in your static files #}
    <meta property="og:image" content="{% block og_image %}{% static 'images/default_og_image.png' %}{% endblock %}">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <!-- Replace @YourTwitterHandle with your actual Twitter handle -->
    <meta name="twitter:creator" content="@YourTwitterHandle">
    <meta name="twitter:title" content="{% block twitter_title %}Akhil Karwal - Personal Portfolio{% endblock %}">
    <meta name="twitter:description" content="{% block twitter_description %}Welcome to the personal portfolio of Akhil Karwal, showcasing projects and skills.{% endblock %}">
    <meta name="twitter:image" content="{% block twitter_image %}{% static 'images/default_og_image.png' %}{% endblock %}">
    ...
    'preload' fetches the stylesheet without blocking rendering. The `onload`
    event then applies the stylesheet to the document.
    -->
    ...
    <!-- Font Awesome for social icons (loaded asynchronously from its CDN) -->
...
<body>
    <!-- Example Navigation: Add a link to your profile page in your site's navbar -->
    <nav class="main-nav">
        <a href="/">Home</a>
        <a href="#">Projects</a>
        <a href="{% url 'persinfo:profile' %}">Profile</a>
        <a href="#">Contact</a>
    </nav>
...
================================================
User-agent: *
Disallow: /akhil-secret-portal/

Sitemap: https://akhilkarwal.com/sitemap.xml
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    <url>
        <loc>https://www.akhilkarwal.com/</loc>
        <changefreq>weekly</changefreq>
        <priority>1.0</priority>
    </url>
    <url>
        <loc>https://www.akhilkarwal.com/projects/</loc>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
    <url>
        <loc>https://www.akhilkarwal.com/contact/</loc>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
</urlset>
...
================================================
FILE: tests/recreate_zone_parallel.py
================================================
import subprocess
import json
import sys
...
================================================
FILE: tests/test_live_darkmode.py
================================================
...
`persinfo\migrations\0001_initial.py`:
...
`persinfo\static\site.webmanifest`:
...
`persinfo\templates\persinfo\404.html`:
...
`persinfo\templates\persinfo\429.html`:
...
`persinfo\templates\persinfo\500.html`:
...
`persinfo\templates\persinfo\base.html`:
...
<head>
    ...
    <script>
        // Only apply a saved theme if the user explicitly chose one via the toggle.
        // Default is always light — do NOT auto-apply OS dark mode preference.
        try {
            const savedTheme = localStorage.getItem('theme');
            if (savedTheme === 'dark' || savedTheme === 'light') {
                document.documentElement.setAttribute('data-theme', savedTheme);
    ...
    <!-- Font Awesome — non-blocking (fixes render-blocking resources warning) -->
    <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"></noscript>
...
`persinfo\templates\persinfo\contact.html`:

```html
{% extends 'persinfo/base.html' %}

{% block meta_description %}Get in touch with Akhil Karwal — Python and Django web developer. Connect via GitHub, LinkedIn, Instagram, Facebook or send a direct message. Open to collaboration, job opportunities, and freelance projects.{% endblock %}
...
`persinfo\templates\persinfo\home.html`:

```html
{% extends 'persinfo/base.html' %}

{% block title %}Akhil Karwal — Python & Django Developer Portfolio{% endblock %}

{% block meta_description %}Akhil Karwal is a results-oriented Python and Django web developer based in India, specialising in scalable web apps, automation testing with Playwright & Selenium, Docker containerisation, and AI-powered tools. Open to opportunities — view projects and connect.{% endblock %}

{% block og_title %}Akhil Karwal — Python & Django Developer{% endblock %}
{% block og_description %}Explore Akhil Karwal's portfolio of Python, Django, and AI projects. Skilled in web development, automation, and containerisation. Available for collaboration and full-time roles.{% endblock %}
...
`persinfo\templates\persinfo\project.html`:
...
`persinfo\templates\persinfo\project_detail.html`:
...
`persinfo\templates\persinfo\projects.html`:

```html
{% extends 'persinfo/base.html' %}

{% block meta_description %}Browse all projects by Akhil Karwal — a Python and Django developer. Explore web apps, AI tools, and automation projects built with Django, Flask, Docker, Playwright, and Selenium. View live demos and source code on GitHub.{% endblock %}
...
`tests\recreate_zone_parallel.py`:
